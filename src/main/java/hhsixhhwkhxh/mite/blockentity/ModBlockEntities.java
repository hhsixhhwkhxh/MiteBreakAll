...
public class ModBlockEntities{
    ...
    public static final Supplier<BlockEntityType<FurnaceCoreBlockEntity>> FURNACE_CORE = BLOCK_ENTITIES.register("furnace_core",()-> new BlockEntityType<>(FurnaceCoreBlockEntity::new,false, ModBlocks.STONE_FURNACE_CORE.get(),ModBlocks.OBSIDIAN_FURNACE_CORE.get(),ModBlocks.NETHERRACK_FURNACE_CORE.get()));
